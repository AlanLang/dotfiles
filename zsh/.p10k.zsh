# Generated by Powerlevel10k configuration wizard on 2022-08-28 at 11:24 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    direndirenvv                  # direnv status (https://direnv.net/)
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=12
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=10
